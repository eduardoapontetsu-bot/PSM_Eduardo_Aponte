...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest psm_eduardo_aponte -- --template=react  --no-rolldown --no-immediate`.
- Actualizando `vite.config.js` con puerto.
- Crear archivo de proyecto (`psm_eduardo_aponte.esproj`).
